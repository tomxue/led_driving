...
//Beagle Board uses a transistor to drive the LED, which is controlled by GPIOD
...
#define GPIO5_OE_OFFSET                 0x034           //P3489, Output Data Er
...
int gpio(int status, int ongoing)
{
    ...
    padconf &= ~(GPIO139+GPIO138);  // Set GPIO_149 & GPIO_150 (GPIO 4 bit 2) t
